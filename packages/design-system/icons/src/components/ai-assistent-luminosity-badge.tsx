...
const AiAssistentLuminosityBadge = React.forwardRef<SVGSVGElement, IconProps>(
...
AiAssistentLuminosityBadge.displayName = "AiAssistentLuminosityBadge"
export default AiAssistentLuminosityBadge
